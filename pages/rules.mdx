...
3. You may not abuse exploits, instead report the issue.
4. You may not advertise servers hosted outside of Minefly.
5. You must keep your server name, description, and content appropriate
...
8. You may not release other users personal or private information without specific approval from the owner of said information.
9. You may not use other accounts to bypass any punishments.

### Lobby Rules

1. You may not promote external servers with the `/advertise` (or `/ad`) command.
